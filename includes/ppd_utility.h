 ...
 **/
BOOLEAN load_data(struct ppd_system * , const char * coins_name , const char * stock_name);
...
int get_input(int long * select, char string_input[DESCLEN+1], int type, int size);
