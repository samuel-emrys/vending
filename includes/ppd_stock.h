...
/*#include "ppd_main.h" nested too deeply, fix using newer startup code */
#ifndef PPD_STOCK
#define PPD_STOCK
#define STOCK_DELIM "|"
#define PRICE_DELIM "."
#define COUNT_VALID_CHARS "0123456789"
#define NEWLINE_CHARLEN 1
...
typedef struct ppd_stock Stock;
...
struct ppd_list
{
     ...
     **/
    struct ppd_node * head; /*first point is null*/
    /**
     * how many nodes are there in the list?
     **/
    unsigned count;
};
typedef struct ppd_list LinkedList;
